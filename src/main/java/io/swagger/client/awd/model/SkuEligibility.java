...
import io.swagger.client.awd.model.SkuIneligibilityReason;
 ...
 */
@ApiModel(description = "Represents eligibility of one SKU.")
...
public class SkuEligibility {
  ...
  **/
  @ApiModelProperty(value = "If not eligible, these are list of error codes and descriptions.")
