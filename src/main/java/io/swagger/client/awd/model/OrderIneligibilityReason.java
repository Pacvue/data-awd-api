 ...
 */
@ApiModel(description = "Represents one ineligibility reason for the order (there can be multiple reasons).")
...
public class OrderIneligibilityReason {
   ...
   * @return code
  **/
  @ApiModelProperty(example = "INVALID_MSKU", required = true, value = "Code for the order ineligibility.")
   ...
   * @return description
  **/
  @ApiModelProperty(example = "The MSKU passed as part of order is invalid", required = true, value = "Description detailing the ineligibility reason of the order.")
