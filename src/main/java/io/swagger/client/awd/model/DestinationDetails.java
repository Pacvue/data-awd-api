 ...
 */
@ApiModel(description = "Destination details of an inbound order based on the assigned region and DC for the order.")
...
public class DestinationDetails {
  ...
  **/
  @ApiModelProperty(value = "Destination address of the AWD facility where the shipment will be shipped to")
  ...
  **/
  @ApiModelProperty(example = "us-west", value = "Assigned region where the order will be shipped. This can differ from what was passed as preference. AWD currently supports following region IDs: [us-west, us-east, us-southcentral, us-southeast]")
   ...
   * @return shipmentId
  **/
  @ApiModelProperty(value = "Unique ID of the confirmed shipment being shipped to the assigned destination. This will be available only after an inbound order is confirmed and can be used to track the shipment.")
