 ...
 */
@ApiModel(description = "Information pertaining to the preparation of inbound products.")
...
public class PrepInstruction {
  ...
  **/
   ...
   * @return prepType
  **/
  @ApiModelProperty(value = "The type of preparation to be done. For more information about preparing items, refer to [Prep guidance](https://sellercentral.amazon.com/help/hub/reference/external/GF4G7547KSLDX2KC) on Seller Central.")
