...
import io.swagger.client.awd.model.PrepDetails;
import io.swagger.client.awd.model.ProductAttribute;
...
public class ProductQuantity {
   ...
   * @return attributes
  **/
  @ApiModelProperty(example = "{\"name\":\"TestAttribute\",\"value\":\"TestAttributeValue\"}", value = "Contains attributes for this instance of the product. For example, item color, or other attributes that distinguish the product beyond the SKU. This is metadata for the product and Amazon does not process this data.")
  ...
  **/
   ...
   * @return expiration
  **/
  @ApiModelProperty(value = "The expiration date for the SKU. Values are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.")
   ...
   * @return prepDetails
  **/
  @ApiModelProperty(value = "Preparation details of a product which contains the prep category, prep owner and the label owner. If not passed while creating an inbound order, NO_PREP will be used on the product by-default. Prep instructions will be generated based on the category passed")
