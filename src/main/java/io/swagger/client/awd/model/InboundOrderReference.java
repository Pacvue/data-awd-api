 ...
 */
@ApiModel(description = "A response that contains the reference identifiers for the newly created or updated inbound order. Consists of an order ID and version.")
...
public class InboundOrderReference {
   ...
   * @return orderId
  **/
  @ApiModelProperty(required = true, value = "Order ID of the inbound order.")
