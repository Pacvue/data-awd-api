 ...
 */
@ApiModel(description = "Payload for creating an inbound order.")
...
public class InboundOrderCreationData {
  ...
  **/
  @ApiModelProperty(example = "[{\"count\":1,\"distributionPackage\":{\"contents\":{\"products\":[{\"quantity\":1,\"sku\":\"testPen\"}]},\"measurements\":{\"dimensions\":{\"height\":1,\"length\":1,\"unitOfMeasurement\":\"INCHES\",\"width\":1},\"volume\":{\"unitOfMeasurement\":\"CUIN\",\"volume\":1},\"weight\":{\"unitOfMeasurement\":\"POUNDS\",\"weight\":1}},\"type\":\"CASE\"}}]", required = true, value = "List of packages to be inbounded.")
