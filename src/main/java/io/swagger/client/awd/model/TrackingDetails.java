 ...
 */
@ApiModel(description = "Tracking details for the shipment. If using SPD transportation, this can be for each case. If not using SPD transportation, this is a single tracking entry for the entire shipment.")
...
public class TrackingDetails {
   ...
   * @return carrierCode
  **/
  @ApiModelProperty(value = "Unique or identifying code for the carrier.")
   ...
   * @return bookingId
  **/
  @ApiModelProperty(required = true, value = "The identifier that is received from transportation to uniquely identify a booking.")
