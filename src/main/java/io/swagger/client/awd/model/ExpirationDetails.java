 ...
 */
@ApiModel(description = "The expiration details of the inventory. This object will only appear if the details parameter in the request is set to `SHOW`.")
...
public class ExpirationDetails {
   ...
   * @return expiration
  **/
  @ApiModelProperty(value = "The expiration date of the SKU.")
  ...
  **/
  @ApiModelProperty(value = "The quantity that is present in AWD.")
