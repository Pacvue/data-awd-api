...
import io.swagger.client.awd.model.InboundEligibilityStatus;
import io.swagger.client.awd.model.OrderIneligibilityReason;
import io.swagger.client.awd.model.SkuEligibility;
 ...
 */
@ApiModel(description = "Represents the eligibility status of the inbound packages.")
...
public class InboundEligibility {
  ...
  **/
  @ApiModelProperty(value = "If there are order level eligibility issues, then this list will contain those error codes and descriptions.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Details on SKU eligibility for each inbound package.")
   ...
   * @return previewedAt
  **/
  @ApiModelProperty(required = true, value = "Timestamp when the eligibility check is performed.")
