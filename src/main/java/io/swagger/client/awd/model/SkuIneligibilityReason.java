 ...
 */
@ApiModel(description = "Represents the ineligibility reason for one SKU.")
...
public class SkuIneligibilityReason {
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Code for the SKU ineligibility.")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "Detailed description of the SKU ineligibility.")
