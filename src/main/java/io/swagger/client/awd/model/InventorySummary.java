...
import io.swagger.client.awd.model.ExpirationDetails;
import io.swagger.client.awd.model.InventoryDetails;
...
public class InventorySummary {
  ...
  **/
  @ApiModelProperty(value = "The expiration details of the inventory. This object will only appear if the `details` parameter in the request is set to `SHOW`.")
